 ...
 * @class
 */
export default function RTL2832U(conn, ppm, opt_gain) {
  /**
   ...
   * @returns {number} The sample rate that was actually set as its first parameter.
   */
   ...
   * @returns {ArrayBuffer} An ArrayBuffer containing the read samples, which you
